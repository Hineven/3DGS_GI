...
bool Renderer::CreateResources () {
    // a maximum of 8 million gaussians
    int max_num_gaussians = 1024 * 1024 * 8;
    ...
    buf_.active_gaussian_instance_count = gfxCreateBuffer<int>(gfx, max_num_gaussians);
    buf_.active_gaussian_color = gfxCreateBuffer<glm::vec3>(gfx, max_num_gaussians);
    buf_.active_gaussian_instance_key = gfxCreateBuffer<int>(gfx, max_num_gaussians);
    buf_.active_gaussian_instance_key_sorted = gfxCreateBuffer<int>(gfx, max_num_gaussians);
    buf_.active_gaussian_instance_gaussian_index = gfxCreateBuffer<int>(gfx, max_num_gaussians);
    buf_.active_gaussian_instance_gaussian_index_sorted = gfxCreateBuffer<int>(gfx, max_num_gaussians);
    buf_.tile_gaussian_instance_start = gfxCreateBuffer<int>(gfx, width * height);
